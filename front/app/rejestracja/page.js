...
export default function Rejestracja() {
    ...
    return (
        <div className="min-h-[calc(100vh-50px)] pt-[60px] flex items-center justify-center ">
            <Formik
                initialValues={{
                    login: "",
                    haslo: "",
            ...
            >
                {({ isValid }) => (
                    <Form
                        autoComplete="off"
                        className="w-[400px] rounded-xl bg-[#405E3F] p-8
                       flex flex-col items-center shadow-xl"
                    >
                        {/* LOGIN */}
                        <p className="text-white self-start mb-1">Login</p>
                        <Field
                            name="login"
                        ...
                        {/* EMAIL */}
                        <p className="text-white self-start mb-1">Email</p>
                        <Field
                            name="email"
                            type="email"
                        ...
                        {/* HASŁO */}
                        <p className="text-white self-start mb-1">Hasło</p>
                        <Field
                            name="haslo"
                            type="password"
                        ...
                        {/* POWTÓRZ HASŁO */}
                        <p className="text-white self-start mb-1">Powtórz hasło</p>
                        <Field
                            name="powtorHasla"
                            type="password"
