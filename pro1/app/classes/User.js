...
export default function User({userq=null}) {
    ...
    return (
        ...
        <div style={{background: "gold", justifyContent: "center"}}>
            {user.typUzytkownika==="Druzynowy"&& <FaTrash onClick={()=>deleteFromList(userw.id,"User")}/>}
            ...
            <p>type of User:{userw.typUzytkownika}</p>
            ...
            {(user.typUzytkownika==="Druzynowy"||user===userw)&& <button onClick={()=>zmienEdycje(userw)}>Edit</button>}
